...
#ifndef J4A__com_media_gankers_medianative_Buffer__H
#define J4A__com_media_gankers_medianative_Buffer__H
#include <sys/cdefs.h>
...
__END_DECLS
#endif//J4A__com_media_gankers_medianative_Buffer__H
