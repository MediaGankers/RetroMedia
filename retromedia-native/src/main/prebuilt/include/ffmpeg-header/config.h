...
#define FFMPEG_CONFIGURATION "--target-os=linux --disable-muxers --disable-demuxers --enable-demuxer=aac --enable-demuxer=ape --enable-demuxer=asf --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flac --enable-demuxer=flv --enable-demuxer=h261 --enable-demuxer=h263 --enable-demuxer=h264 --enable-demuxer=hls --enable-demuxer=latm --enable-demuxer=loas --enable-demuxer=m4v --enable-demuxer=matroska --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegtsraw --enable-demuxer=mpegvideo --enable-demuxer=ogg --enable-demuxer='pcm_*' --enable-demuxer=rm --enable-demuxer=rtp --enable-demuxer=rtsp --enable-demuxer=swf --enable-demuxer=tta --enable-demuxer=vc1 --enable-demuxer=vc1t --enable-demuxer=wav --enable-demuxer=xmv --logfile=config.log --arch=arm --enable-cross-compile --cross-prefix=arm-linux-androideabi- --disable-shared --disable-symver --disable-doc --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-ffserver --disable-avdevice --disable-postproc --disable-avresample --enable-protocols --enable-fft --enable-pthreads --enable-nonfree --disable-network --enable-hwaccels --enable-swresample --enable-libx264 --disable-encoders --disable-decoders --enable-encoder=libx264 --enable-encoder=mjpeg --enable-muxer=mjpeg --enable-decoder=mjpeg --enable-decoder=mp3 --enable-encoder=mp3 --enable-decoder=h264 --enable-parser=h264 --enable-decoder=hevc --enable-parser=hevc --enable-demuxer=hevc --enable-decoder=mpeg4 --enable-decoder=h263 --enable-encoder=mp2 --enable-decoder=amrnb --enable-decoder=amrwb --enable-demuxer=mjpeg --enable-demuxer=image2 --enable-protocol=file --enable-filter=concat --enable-filter=amix --enable-filter=atempo --enable-muxer=h264 --enable-muxer=mp4 --enable-demuxer=mp4 --enable-demuxer=h264 --enable-demuxer=aac --enable-encoder=aac --enable-decoder=aac --enable-muxer=adts --enable-hwaccels --enable-bsf=aac_adtstoasc --enable-zlib --enable-encoder=pcm_s16le --enable-decoder=pcm_s16le --enable-muxer=pcm_s16le --enable-demuxer=pcm_s16le --enable-muxer=wav --enable-demuxer=wav --enable-filter=aformat --enable-filter=aresample --enable-libfdk-aac --enable-nonfree --enable-encoder=libfdk_aac --enable-asm --enable-gpl --enable-version3 --enable-pic --disable-protocol=applehttp --disable-protocol=fd --disable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=hls --disable-protocol=http --disable-protocol=httpproxy --disable-protocol=md5 --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol=mmsu --disable-protocol=pipe --enable-protocol=rtmp --enable-protocol=file --disable-decoder=cavs --disable-protocol=rtmpt --disable-protocol=rtmpts --disable-protocol=rtp --disable-protocol=tcp --disable-protocol=udp --disable-protocol=crypto --disable-protocol=cache --disable-protocol=concat --disable-debug --disable-symver --disable-zlib --disable-stripping --disable-logging --disable-indevs --enable-small --disable-outdevs --enable-version3 --prefix=/Users/silei/Desktop/VideoSDK/out/ --extra-cflags='-O3 -Wall -mthumb -pipe -fpic -fasm -finline-limit=300 -ffast-math -fstrict-aliasing -Wno-strict-aliasing -fmodulo-sched -fmodulo-sched-allow-regmoves -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -march=armv7-a -mfpu=neon -mfloat-abi=softfp -mvectorize-with-neon-quad -O3 -I/Users/silei/Desktop/VideoSDK/out//include -I/Users/silei/Desktop/VideoSDK/out//include/fdk-aac -I/Users/silei/Desktop/VideoSDK/out//include/x264' --extra-ldflags='-Wl,--fix-cortex-a8 -L/Users/silei/Desktop/VideoSDK/out//lib'"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/Users/silei/Desktop/VideoSDK/out//share/ffmpeg"
#define AVCONV_DATADIR "/Users/silei/Desktop/VideoSDK/out//share/ffmpeg"
